	...
	return (
        ...
        <section className='bg-dark-blue h-[800px]'>
			<div className='modal-container flex justify-center items-center relative'>
				<div className='modal-content p-5 bg-white rounded-lg absolute max-w-[425px] w-10/12 lg:w-1/3 h-7/8 max-h-[500px] top-56'>
					<form onSubmit={formik.handleSubmit} className='text-black'>
						...
						<div className='flex flex-col items-center mt-8'>
							...
							<Link className='mx-4 hvr-fade text-link-blue hover:text-link-blue-hover' href='/login'>
					Login
				</Link>
						</div>
					</form>
